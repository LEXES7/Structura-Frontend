...
export default function FooterCom() {
  return (
    <Footer container={false} className="w-full bg-black text-white p-4 m-0 rounded-none">
      <div className="w-full max-w-7xl mx-auto">
        <div className="grid w-full justify-between sm:flex md:grid-cols-1">
          <div className="mt-8 ml-4">
            <Link to="/" className="self-center whitespace-nowrap text-lg sm:text-xl font-semibold dark:text-white">
              <span className="px-2 py-1 bg-gradient-to-r from-red-500 via-yellow-500 to-gray-600 rounded-lg text-white">
                Structura
              </span>
            </Link>
          </div>
          <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6">
            ...
            <div>
              ...
              <FooterLinkGroup col>
                <FooterLink href="https://github.com/LEXES7" target="_blank" rel="noopener noreferrer">
                  Github
                </FooterLink>
